...
| 4.13 antibiotic code | `antibiotic_code` | `select_one` incl. `96 = Other` | None — `96` is a named category, not a numeric measurement | `antibiotic_other` captures the free-text write-in, `relevant` only when `antibiotic_code='96'` |
