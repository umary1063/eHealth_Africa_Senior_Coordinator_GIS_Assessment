...
- **`version`** (`settings` sheet, currently `2026073101`) changes on every published edit. I used
...
is the environment `form/HH2026_v1.xlsx` was actually uploaded to and tested against, per
`documentation/11_scope_and_omissions.md`, item 9. Version `2026073100` was the first version
tested there; live rendering on that instance surfaced a real Section 7 relevance bug (same item),
fixed in `2026073101`.
